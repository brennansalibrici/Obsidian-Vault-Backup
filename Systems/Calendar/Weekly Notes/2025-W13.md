---
Created: 2025-03-25T19:41:32
Summary: 
Personal: 
Career: 
Total: 0
Parent: "[[My Calendar/My Monthly Notes/2025-M03|2025-M03]]"
cssclasses: 
Previous: 
Next: 
journal: Week
...
---
[[My Calendar/My Weekly Notes/2025-W12|2025-W12]] ⬅️ [[My Calendar/My Monthly Notes/2025-M03|2025-M03]] ➡️ [[My Calendar/My Weekly Notes/2025-W14|2025-W14]]
...
```dataview
task
where file.name = "2025-W12" AND !completed
```
### Projects
...
from ""
WHERE date(2025-03-24) < Created AND Created < date(2025-03-30) and obstacle
SORT file.name asc
```
### New Notes
```datacorejsx
...
### Completed Tasks
```tasks
due in 2025-03-24 to 2025-03-30
group by path
sort by due
```
### Key Metrics
