...
Body: 1
journal: Week
journal-start-date: 2025-04-13
journal-end-date: 2025-04-19
journal-date: 2025-04-13
---
[[My Calendar/My Weekly Notes/2025-W15|2025-W15]] ⬅️ [[My Calendar/My Monthly Notes/2025-M04|2025-M04]] ➡️ [[My Calendar/My Weekly Notes/2025-W17|2025-W17]]
...
```dataview
task
where file.name = "2025-W15" AND !completed
```
### Projects
...
from ""
WHERE date(04-14-2025) < Created AND Created < date(2025-04-20) and obstacle
SORT file.name asc
```
### New Notes
```datacorejsx
...
### Completed Tasks
```tasks
due in 2025-04-14 to 2025-04-20
group by path
sort by due
```
### Key Metrics
